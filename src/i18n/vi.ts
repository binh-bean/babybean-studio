...
export const vi = {
  ...
  admin: {
    branches: {
      ...
      usage: "{staff} nhân sự · {galleries} album",
      open: "Đang mở",
      closed: "Đã đóng",
      noAddress: "chưa nhập",
      ...
      reopen: "Mở lại",
      confirmClose: "Đóng chi nhánh {name}? Album và lịch sử vẫn giữ nguyên, chỉ không tạo mới được nữa.",
    ...
    wizard: {
      ...
      create: "Tạo album",
      creating: "Đang tạo…",
      pinLabel: "Mã PIN gửi khách",
      copied: "Đã sao chép",
      backToList: "Về danh sách album",
