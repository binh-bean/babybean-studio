...
/** CSKH trở lên. Người chỉnh ảnh không tự mở lại bộ ảnh của mình. */
const REOPEN_ROLES = ["owner", "admin", "branch_manager", "cs"] as const;
...
export async function POST(
  ...
  try {
    ...
    requireRole(staff, REOPEN_ROLES as unknown as Parameters<typeof requireRole>[1]);
