...
/** Hình thức thu ngoài app. Danh sách đóng để báo cáo gộp được. */
const METHODS = ["chuyen_khoan", "tien_mat", "pos", "vi_dien_tu", "khac"];
...
export async function POST(
  ...
  try {
    ...
    if (!METHODS.includes(method)) {
      return fail("INVALID_INPUT", `Hình thức thu phải là một trong: ${METHODS.join(", ")}`);
    }
