...
/** CSKH trở lên. Người photoshop chỉnh ảnh nhưng không tự gửi cho khách. */
const SEND_ROLES = ["owner", "admin", "branch_manager", "cs"] as const;
...
export async function POST(
  ...
  try {
    ...
    requireRole(staff, SEND_ROLES as unknown as Parameters<typeof requireRole>[1]);
