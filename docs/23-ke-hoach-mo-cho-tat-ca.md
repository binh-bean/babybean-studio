...
5. ✅ Sao lưu tự động (BB-273) — chạy trên GitHub Actions, không phụ thuộc máy
   studio, "ngủ" (job xanh, không làm gì) cho tới khi chủ studio thêm 2 Secret.
   Tệp kết xuất được mã hoá AES-256-GCM ngay trên máy chủ Actions trước khi
   đăng lên artifact — repo công khai nên KHÔNG có tệp .sql đọc được nào rời
   máy chủ. Chi tiết cho chủ studio (không cần biết lập trình): `docs/24-sao-luu-tu-dong.md`.
