...
| BB-108 | **Gỡ công tắc watermark khỏi giao diện.** Nó chạy đủ một vòng nhưng không component nào vẽ watermark — CSKH bật, hệ thống báo đã bật, ảnh vẫn ra sạch. Hứa suông về một thứ bảo vệ không tồn tại | DEV-FE | — | med | ✅ **DONE** — Bỏ ô watermark, download mặc định bật sẵn, requirePin mặc định tắt; kiểm ngược DB khớp, test canh giữ 319/319 xanh |
