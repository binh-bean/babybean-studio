...
| BB-172 | **Màn Vai trò và quyền.** Tự tạo vai trò, tích chọn chức năng và mức quyền đọc/ghi/sửa/xoá cho từng vai. Hiện vai trò là danh sách cứng trong `docs/05-rbac.md` và luật quyền nằm trong CSDL | ARCH + SEC-ARCH | — | high | ✅ **CHẶNG 1 XONG 18/09** — ADR-0007. Chốt `owner` bất biến, chặn ở cả CSDL lẫn API. Chặng 2 chưa giao |
| BB-173 | **Lịch sử thao tác và phiên đăng nhập của từng nhân sự.** Bảng `activity_logs` đã có sẵn 6.420 dòng nhưng **chưa màn nào đọc**. Gộp BB-064 | DEV-FE | — | med | **ĐÃ GIAO 21/09** — brief `docs/briefs/BB-173-man-lich-su-thao-tac.md`. Reviewer đo ra: **9.507/9.823 dòng (96,8%) trỏ vào bộ ảnh đã bị xoá** — rác do phép thử. Dựng màn không phải phần khó; làm cho nhật ký đáng tin mới là |
