...
| BB-170 | **Kanban nói dối: cột khoe tổng thật nhưng chỉ vẽ thẻ từ 50 bộ mới nhất.** `gallery-list.tsx` dòng 201 đặt `limit=50`; dòng 579 lọc thẻ từ 50 bộ đó; dòng 580 lấy số đếm tổng từ máy chủ. Đo 17/09 trên bb-dev: cột "Sẵn sàng" hiện **357** và **không một thẻ nào**, "Lỗi tải ảnh" hiện **0** trong khi có **76**. Mỗi cột phải tự tải dữ liệu của nó | DEV-FE + DEV-BE | — | med | ⚠️ **TODO — chủ studio báo 17/09**, lỗi nhìn thấy được |
