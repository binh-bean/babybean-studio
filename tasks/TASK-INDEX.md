...
| BB-166 | **Nút "Nhắn cho studio" trên màn khách.** Mở thẳng ứng dụng chat qua deep link. **KHÔNG nhúng mã Facebook** — trang này hiện ảnh trẻ em, và BB-074 đã tự host font chỉ để không gửi IP khách ra ngoài | DEV-FE | — | low | ✅ **SẴN SÀNG GIAO** — đích `https://m.me/113878833349843`, một Page chung cho ba chi nhánh. Địa chỉ **không ghi cứng**: đặt cạnh `branches.zalo_oa`. Không cấu hình thì không vẽ nút |
