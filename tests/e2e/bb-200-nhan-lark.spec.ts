...
test.describe("BB-200: nhãn trạng thái hậu kỳ từ Lark", () => {
  ...
  test.beforeAll(async () => {
    ...
    await client.query(`delete from galleries where title like 'Fixture BB-200%' and created_at < now() - interval '6 hours'`);
    await client.query(`delete from customers where full_name like 'Fixture BB-200%' and created_at < now() - interval '6 hours'`);
